...
hxx_tree::hxx_tree()
{
   ...
   phot_pt     = new std::vector<double>;
   phot_eta    = new std::vector<double>;
   phot_phi    = new std::vector<double>;
   diphot_minv = new std::vector<double>;   
...
void hxx_tree::WriteTree(TTree * tree){   
   ...
   // photons:
   tree->Branch("phot_pt",     phot_pt);
   tree->Branch("phot_eta",    phot_eta);
   tree->Branch("phot_phi",    phot_phi);
   tree->Branch("diphot_minv", diphot_minv);
...
void hxx_tree::ReadTree(TTree * tree){
   ...
   delete phot_pt;     phot_pt     = NULL;
   delete phot_phi;    phot_phi    = NULL;
   delete phot_eta;    phot_eta    = NULL;
   delete diphot_minv; diphot_minv = NULL;
   ...
   tree->SetBranchAddress("phot_pt",     &phot_pt     );
   tree->SetBranchAddress("phot_phi",    &phot_phi    );
   tree->SetBranchAddress("phot_eta",    &phot_eta    );
   tree->SetBranchAddress("diphot_minv", &diphot_minv );
